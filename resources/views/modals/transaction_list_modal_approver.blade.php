                        ...
                        <div class="block-content tab-content overflow-hidden my-2">
                            ...
                            <div class="tab-pane fade" id="btabs-animated-fade-profile" role="tabpanel"
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            <div>
                                                <input type="hidden" id="routeUrl"
                                                    value="{{ route('upload_transaction_approver') }}">
                                ...
                                <table id="modalTableAuto"
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="bg-warning text-light text-center" colspan="3">Collections</th>
                                            <th class="bg-earth text-light text-center" colspan="3">Accounting</th>
                                            <th class="bg-primary text-light text-center" colspan="3">Approver</th>
                                            <th class="bg-secondary text-light text-center">Other</th>
                                        </tr>
                                        <tr>
                                            <th>Id</th>
